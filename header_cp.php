...
<body>
  ...
  <tr >
    <td class="label_header" width="25%">
      ...
      <span class="menu"><a href="submit_mission.html">发布任务</a></span></td>
    <td class="label_header" width="25%">
      <img src="s-logo.gif" alt="" height="20" width="20" />
      <span class="menu"><a href="results2.php">查询bug</a></span></td>
    <td class="label_header" width="25%" >
      <img src="s-logo.gif" alt="" height="20" width="20" />
      <span class="menu" ><a href="my.php">任务中心</a></span></td>
    <td class="label_header" width="25%">
      <img src="s-logo.gif" alt="" height="20" width="20" />
