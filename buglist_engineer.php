...
?>
			...
			<br><br>
			<div>
			<div style="margin-bottom:20px;width:45%;float:left">
				<div>截图1:</div>
				<img id="display_photo1" name="display_photo1" width="90%" src="">
			</div>
			<div style="margin-bottom:20px;width:45%;float:left">
				<div>截图2:</div>
				<img id="display_photo2" name="display_photo2" width="90%" src="">
			</div>
			</div>
		</form>
	</div>
