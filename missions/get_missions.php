<?php
	...
	$rs= mysql_query("select project.pid, project.pname, project.ptime, userproject.status, userproject.status, project.pid from project left join userproject on project.pid = userproject.pid and userproject.uid='$uid' limit $offset,$rows");
	$items = array();
